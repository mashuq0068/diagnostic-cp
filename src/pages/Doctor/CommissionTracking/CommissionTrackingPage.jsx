...
const CommissionTrackingPage = () => {
  ...
  useEffect(() => {
    getAllDoctorCommissions();
  }, [queryParams]);

  const getAllDoctorCommissions = async () => {
    setLoading(true);
    try {
      const queryData = buildQueryParams(queryParams);
      const res = await axios.get(`/doctor-commissions?${queryData}`);

      setDoctorCommissions(res?.data?.doctorCommissions);
      ...
      <div className="wrapper">
        ...
        <div className="overflow-x-auto">
          <table className="table min-w-full">
            ...
            <tbody>
              {doctorCommissions?.map((commission, index) => (
