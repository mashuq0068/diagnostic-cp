...
const PatientLedgerPage = () => {
  ...
  const handleSearchChange = (e) => {
    ...
    const filtered = patientLedgers.filter((patientLedger) =>
      patientLedger.patientName.toLowerCase().includes(searchTerm)
    );
    setPatientLedger(filtered);
  };
  return (
    <div className="mb-8">
      <div>
